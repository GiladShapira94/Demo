...
- Storage: 7Gi
- You must configure youre K8s (Minikube, Docker Desktop) with minimum of 2 CPU and 8GB Memory resources
...
- `<your-registry-server>` is your Private Docker Registry FQDN. (**ht<span>tps:/</span>index.docker.io/v1/** for Docker Hub).
